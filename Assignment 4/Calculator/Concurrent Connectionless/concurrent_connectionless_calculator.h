#ifndef _CONCURRENT_CONNECTIONLESS_CALCULATOR_H_RPCGEN
#define _CONCURRENT_CONNECTIONLESS_CALCULATOR_H_RPCGEN
...
#endif /* !_CONCURRENT_CONNECTIONLESS_CALCULATOR_H_RPCGEN */
